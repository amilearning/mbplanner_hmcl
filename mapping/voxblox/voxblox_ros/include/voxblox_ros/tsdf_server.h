...
class TsdfServer {
 public:
  ...
  void lidar_inserPointcloud(const sensor_msgs::LaserScan::Ptr& laser_pointcloud);
  ...
  virtual void processPointCloudMessageAndInsert(
      ...
      const Transformation& T_G_C, const bool is_freespace_pointcloud, bool lidar_source = false);
